# HealthArc
Data4Good 2026 project - Health and Lifestyle tracker and guide - Towards a healthier lifestyle.

Collaboration doc:
[https://docs.google.com/document/d/1UPbi094DI8s2AYOddZAcc0xXrvOLbvhOncByfufajN8/edit?usp=sharing](google doc)

balsamiq: 
[https://balsamiq.cloud/sso4lie/pgczt7g]
...
For the backend, we analysed the Health and Lifestyle dataset on Kaggle and trained four different models to predict the lifestyle status (At Risk, optimal, Balanced) of a User. We use different metrics like accuracy and recall to choose the best model and deployed it on render.com. We also use the Gemini API for active and useful suggestions based on the lifestyle.
